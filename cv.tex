...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{{Relevant coursework:} Machine Learning, Deep Learning, Big Data for Healthcare, AI Ethics \& Society, Simulation \& Modeling}
      \resumeItemListEnd
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{{Relevant coursework:} Biostatistics, Linear Algebra \& Numerical Methods, Introduction to Scientific Computing, UNIX Tools}
      \resumeItemListEnd
    \resumeSubheading
